...
namespace Drupal\cecc_shipping_account\Plugin\Commerce\InlineForm;
 ...
 *
 * @CommerceInlineForm(
 *   id = "shipping_account_form",
 *   label = @Translation("Shipping Account Form"),
 * )
 */
class ShippingAccountForm extends EntityInlineFormBase {
