...
class ShippingAccountEditForm extends PaymentMethodFormBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['payment_details']['cecc_shipping_vendor'] = [
      ...
      '#default_value' => $payment_method->cecc_shipping_vendor->isEmpty() ?
      NULL : $payment_method->cecc_shipping_vendor,
    ...
    $form['payment_details']['cecc_shipping_account'] = [
      ...
      '#default_value' => $payment_method->cecc_shipping_account->isEmpty() ?
      NULL : $payment_method->cecc_shipping_account,
      '#required' => TRUE,
      '#maxlength' => 60,
      '#size' => 30,
    ];
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    try {
      $payment_gateway_plugin->updatePaymentMethod($paymentMethod);
      $paymentMethod->save();
    }
