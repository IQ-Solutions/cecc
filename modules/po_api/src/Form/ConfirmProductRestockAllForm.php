...
use Drupal\Core\Url;
use Drupal\po_api\Service\Stock;
...
class ConfirmProductRestockAllForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\po_api\Service\Stock
   */
  protected $stock;
   ...
   *
   * @param \Drupal\po_api\Service\Stock $stock
   *   The stock service.
   */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $batch = [
      ...
      'operations' => [
        [
          '\Drupal\po_api\Form\ConfirmProductRestockAllForm::batchProcessInventory',
          [],
        ],
      ],
      'finished' => '\Drupal\po_api\Form\ConfirmProductRestockAllForm::finishedInventoryRefresh',
    ...
    $form_state->setRedirect('po_api.settings');
  }
  ...
  public static function batchProcessInventory(array &$context) {
    $batchSize = 10;
    /** @var \Drupal\po_api\Service\Stock $stockApi */
    $stockApi = \Drupal::service('po_api.stock');
  ...
  public function getCancelUrl() {
    return Url::fromRoute('po_api.settings');
  }
