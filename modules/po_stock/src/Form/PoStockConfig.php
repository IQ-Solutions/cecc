...
namespace Drupal\po_stock\Form;
 ...
 */
class PoStockConfig extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('po_stock.settings');
