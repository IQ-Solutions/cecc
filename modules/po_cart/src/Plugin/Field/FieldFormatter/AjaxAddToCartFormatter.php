...
namespace Drupal\po_cart\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'po_cart_ajax' formatter.
 *
 * @FieldFormatter(
 *   id = "po_cart_ajax",
...
class AjaxAddToCartFormatter extends AddToCartFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $elements[0]['po_cart_ajax_form'] = [
      '#lazy_builder' => [
        'po_cart.lazy_builders:ajaxAddToCartForm', [
          $items->getEntity()->id(),
          $this->viewMode,
